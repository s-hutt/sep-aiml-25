...
from shapiq_student import run_subset_finding


@pytest.mark.parametrize("max_size", [0, 1, 4, "n_players"])
def test_if_subset_finding_can_be_called(max_size: int | str) -> None:
    ...
    output = run_subset_finding(interaction_values=interaction_values, max_size=max_size)
